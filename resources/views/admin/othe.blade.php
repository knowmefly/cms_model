...
@section('content')
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">作品管理</span><span class="crumb-step">&gt;</span><span class="crumb-name">他山之石</span></div>
        </div>
                        ...
                        @foreach($data as $inputs)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="link-del" href="destroy?table=evaothe&id={{$inputs->id}}">删除</a>
                                </td>
                            </tr>
                        @endforeach
                        {{--<tr>--}}
